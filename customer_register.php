  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT DEVICE DECOR
      </div>
      <p class="nero__text">
      </p>
    </div>
...
$get_email = "select * from customers where email='$email'";
...
<h2>
Email Confirmation By Computerfever.com $name
</h2>

<a href='localhost/ecom_store/customer/my_account.php?$confirm_code'>
...
$insert_customer = "insert into customers (name,email,pass,city,contact,ip,confirm_code) values ('$name','$email','$pass','$city','$contact','$ip','$confirm_code')";
